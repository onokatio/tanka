...
**************************************************/
	...
	// パラメータA (オプション)
	$params_a = array(
		'status' => 'ツイートなう。' ,		// 投稿内容 (必須)
//		'in_reply_to_status_id' => '599621008882946048' ,		// リプライ先のツイートID 
//		'possibly_sensitive' => 'false' ,		// 不適切な可能性のある画像とするか？ 
//		'lat' => '35.79449997305192' ,		// 緯度 
//		'long' => '139.79078800000002' ,		// 経度 
//		'place_id' => 'df51dec6f4ee2b2c' ,		// 場所ID 
//		'display_coordinates' => 'true' ,		// 位置情報を範囲指定にするか？ 
//		'trim_user' => 'false' ,		// ユーザーオブジェクトの省略 
//		'media_ids' => '471592142565957632' ,		// メディアID 
	) ;
